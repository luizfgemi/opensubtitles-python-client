...
class Subtitles200Response(BaseModel):
    """
    ...
    data: Optional[List[Subtitles200ResponseDataInner]] = None
    __properties: ClassVar[List[str]] = ["total_pages", "total_count", "per_page", "page", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "data": [Subtitles200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
