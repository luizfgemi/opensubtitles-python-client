...
class Languages200ResponseDataInner(BaseModel):
    """
    Languages200ResponseDataInner
    """ # noqa: E501
    language_code: Annotated[str, Field(min_length=1, strict=True)]
    language_name: Annotated[str, Field(min_length=1, strict=True)]
