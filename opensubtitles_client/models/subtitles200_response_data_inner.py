...
class Subtitles200ResponseDataInner(BaseModel):
    """
    Subtitles200ResponseDataInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[Subtitles200ResponseDataInnerAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": Subtitles200ResponseDataInnerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
