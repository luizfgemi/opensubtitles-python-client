...
class BuyCredits200Response(BaseModel):
    """
    BuyCredits200Response
    """ # noqa: E501
    data: Optional[List[BuyCredits200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BuyCredits200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
