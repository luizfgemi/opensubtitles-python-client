...
class Languages200Response(BaseModel):
    """
    
    """ # noqa: E501
    data: Annotated[List[Languages200ResponseDataInner], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Languages200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
