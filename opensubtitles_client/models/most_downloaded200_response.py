...
class MostDownloaded200Response(BaseModel):
    """
    ...
    data: Annotated[List[Subtitle], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "data": [Subtitle.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
