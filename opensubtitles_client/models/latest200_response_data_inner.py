...
class Latest200ResponseDataInner(BaseModel):
    """
    ...
    attributes: Optional[Latest200ResponseDataInnerAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": Latest200ResponseDataInnerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
