...
class Latest200Response(BaseModel):
    """
    ...
    data: Annotated[List[Latest200ResponseDataInner], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["total_pages", "total_count", "page", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "data": [Latest200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
